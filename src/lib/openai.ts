...
// consider using a different approach than tone that is paid
// export function generateArtPrompt(userInput: string) {
  //  const prompt = `Please generate an art piece inspired by the phrase "${userInput}"`;
  //  return prompt;
//}